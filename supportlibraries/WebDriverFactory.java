...
public class WebDriverFactory
{
			...
			Platform platform,String platformVersion,String resolution, String remoteUrl, String description)
	{
			...
			desiredCapabilities.setCapability("project", "Fpl.com");
			desiredCapabilities.setCapability("name", description);
			desiredCapabilities.setJavascriptEnabled(true);	// Pre-requisite for remote execution
			...
			try{
				...
				throw new FrameworkException("WebDriver Object", "Unable to create WebDriver object:" + e.getMessage());
